package com.example.testdetectionobject4;
...
import android.graphics.Bitmap; //nessesaire car on utilise Bitmap
...
import android.Manifest; //pour que les Manifest.permission.CAMERA il faut importer cela


import com.example.testdetectionobject4.ml.ModelFR;
        ...
        camera.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {  //verification pour voir c quel version car la methode est juste accesible sur certaine version
                    if(checkSelfPermission(Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED){  //checkSelfPermission marche uniquement sur certaine version
