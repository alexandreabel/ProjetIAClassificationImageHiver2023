package com.example.testdetectionobject6cerise;
...
import com.example.testdetectionobject6cerise.ml.ModelPommeCeriseOrange1;
...
/*MARCHE PO*/
//Il se trompe toujours entre une pomme ,une orange et une cerise
//le modele a une mauvaise performance
public class MainActivity extends AppCompatActivity {
    ...
    public void classifyImage(Bitmap image){   //dans cette methode il faut copié coller le code qui saffiche après limportation du model tflite
        try {
            ...
            ModelPommeCeriseOrange1 model = ModelPommeCeriseOrange1.newInstance(getApplicationContext());
            ...
            ModelPommeCeriseOrange1.Outputs outputs = model.process(inputFeature0);
            ...
            String[] classes = {"pomme", "orange", "cerise"};
