package com.example.testdetectionobject7pommeceriseaugmenter;
...
import com.example.testdetectionobject7pommeceriseaugmenter.ml.ModelPommeCeriseAugmenter1;
...
//Détecte pomme,cerise,orange
//Note:il detecte bien l'orange
//il confond la pomme avec l'orange et surtout la cerise'
//Je ne l'ai pas testé avec une vrai cerise
//mais avec les photo la cerise a laire de marché marche
public class MainActivity extends AppCompatActivity {
    ...
    public void classifyImage(Bitmap image){   //dans cette methode il faut copié coller le code qui saffiche après limportation du model tflite
        try {
            ...
            ModelPommeCeriseAugmenter1 model = ModelPommeCeriseAugmenter1.newInstance(getApplicationContext());
            ...
            ModelPommeCeriseAugmenter1.Outputs outputs = model.process(inputFeature0);
            ...
            String[] classes = {"pomme", "cerise", "orange"};
